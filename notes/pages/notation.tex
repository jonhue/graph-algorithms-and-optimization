...
\begin{longtable}{p{2.5cm}l}
   ...
   $\grad f(\vx)$ & gradient of a function $f$ at a point $\vx$, $\trans{\begin{bmatrix}
   ...
   $D \vg(\vx)$ & Jacobian of vector-valued function $\vg$, $\begin{bmatrix}
        \pdv{\vg(\vx)}{\vx(1)} & \cdots & \pdv{\vg(\vx)}{\vx(n)}
    \end{bmatrix}$ \\
   $\mH_f(\vx)$ & Hessian of $f$, $\trans{D \grad f(\vx)}$ \\
\end{longtable}
