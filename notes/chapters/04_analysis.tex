...
\begin{thm}[Taylor's theorem, first-order form]\index{Taylor's theorem (first-order)} If $f: \sS \to \R$ is continuously differentiable, then for all $\vx, \vy \in \sS$, \begin{align}
...
\begin{thm}[Taylor's theorem, second-order form]\index{Taylor's theorem (second-order)} If $f: \sS \to \R$ is twice continuously differentiable, then for all $\vx, \vy \in \sS$, \begin{align}
