...
\begin{defn}[Volume] The \emph{volume}\index{volume} of a set of vertices $\sS \subseteq \sV$ is, \begin{align}
...
\begin{defn}[Expander decomposition] An \emph{expander decomposition}\index{expander decomposition} is a partition of the vertex set $\sV = \sX_1 \cup \dots \cup \sX_k$ such that \begin{enumerate}
